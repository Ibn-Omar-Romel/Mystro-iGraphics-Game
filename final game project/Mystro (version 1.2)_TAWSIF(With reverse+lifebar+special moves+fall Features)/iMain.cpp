...
void botControl(){
	if (bx - cx <= 100  && bx-cx >=-100){
		int k = rand() % 4;
		key = k + '0';
		iKeyboard(key);

	}
	if (bx - cx > (rand()%1000)+100){
		key = '8';
		freeze = 0;
		//int countee = rand() % 20;
		//while (countee--){
	...
	else if (bx - cx > ((rand()  % 1000) + 100) * - 1   && bx-cx <-100){
		key = '9';
		freeze=0;
		//int countee = rand() % 20;
		//while (countee--){
...
void iDraw()
{
	...
	///button_click
			...
			iShowBMP(0, 0, play);      //play background
						...
						iShowBMP(0, 0, name);                //enter your name
								  ...
								  // iShowBMP2(0, 0, "HeroS6.bmp", 0);
								   ...
								   botMovement();
									...
									//   iSetColor(0, 0, 0);							 							 															  
									//   iSetColor(r1, g1, b1);								  
									//iFilledRectangle(180, 600,500, 60);
									// iSetColor(0, 0, 0);							  
									//  iSetColor(r, g, b);
								  // iFilledRectangle(180, 700, heroLife / 5, 30);
								  // iShowBMP2(160, 700, "HeroLife1(bmp).bmp", 0);
								 

								 
								  // iShowImage(160, 700, 230, 66, iLoadImage("HeroLife1(png).png"));
								  // iShowBMP2(160 + 20, 700 + 10, "HeroLife2(bmp).bmp", 0);
								 ...
								 //  iFilledRectangle(1280, 700, botLife / 5, 30);
								 //  iShowBMP2(1280, 700, "BotLife1(bmp).bmp", 0);
	}
...
int main()
{
	...
	//if (gamestate == 9){
		...
		iSetTimer(300, autoBotChange);
		iSetTimer(rand() + (rand() % 2000)/*+(rand() % 2000)*/, botControl);
	//}
