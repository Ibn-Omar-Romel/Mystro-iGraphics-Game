	...
	///button_click
			...
			iShowBMP(0, 0, play);      //play background
						...
						iShowBMP(0, 0, name);                //enter your name
								   ...
								   iSetColor(0, 0, 0);
								   iRectangle(180, 700, 1000 / 5, 30);
								   iRectangle(180+0.5, 700+0.5, 1000 / 5+0.5, 30+0.5);
								   iRectangle(180 + 1.2, 700 + 1.2, 1000 / 5 ,30);
								   iRectangle(180 , 700 , 1000 / 5, 30);
								   iSetColor(r1, g1, b1);
								   iFilledRectangle(180, 700, heroLife / 5, 30);
								   //iFilledRectangle(180, 600,500, 60);
								   iSetColor(0, 0, 0);
								   iRectangle(1280, 700, 1000 / 5, 30);
								   iSetColor(r, g, b);
